...
# Pydantic Class: Now pydantic will apply validation checks to this class
class Review(BaseModel):
    key_themes: list[str] = Field(description="Write down all the key themes listed in the review")
